...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Color _signupButtonColor = const Color(0xFF7F3DFF);
                ...
                children: [
                  Checkbox(
                    ...
                    onChanged: (value) {
                      setState(() {
                        _agreeToTerms = value!;
                        _signupButtonColor = _agreeToTerms ? Color(0xFF7F3DFF) : Color(0xFF7F3DFF);
                      ...
                      text: const TextSpan(
                        children: [
                          ...
                          TextSpan(
                            ...
                            style: TextStyle(color: Color(0xFF7F3DFF)), // Link color
                          ),
                        ],
                      ),
                    ),
